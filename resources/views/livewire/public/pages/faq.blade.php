...
<main class="main">
    ...
    <div class="cta cta-display bg-image pt-4 pb-4" style="
            background-image: url(static/assets/images/backgrounds/cta/bg-7.jpg);
          ">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9 col-xl-7">
                    <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('public.pages.contact') }}" class="btn btn-outline-white"><span>CONTACT US</span><i
