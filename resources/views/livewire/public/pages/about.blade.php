...
<main class="main">
    ...
    <div class="page-content pb-3">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="about-text text-center mt-3">
                        ...
                        <img src="static/assets/images/about/about-2/signature.png" alt="signature"
                            class="mx-auto mb-5" />

                        <img src="static/assets/images/about/about-2/img-1.jpg" alt="image" class="mx-auto mb-6" />
                    </div>
                    <!-- End .about-text -->
                </div>
        ...
        <div class="bg-image pt-7 pb-5 pt-md-12 pb-md-9" style="
              background-image: url(static/assets/images/backgrounds/bg-4.jpg);
            ">
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-1.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-2.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-3.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-4.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-5.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-6.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-7.jpg" alt="member photo" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="static/assets/images/team/about-2/member-8.jpg" alt="member photo" />
                ...
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <div class="brands-display">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <a href="#" class="brand">
                                    <img src="static/assets/images/brands/9.png" alt="Brand Name" />
                                </a>
                            </div>
                            <!-- End .col-md-3 -->
                        </div>
