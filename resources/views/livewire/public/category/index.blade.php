...
new #[Layout('components.layouts.guest')] class extends Component
{
    ...
    public function mount(CategoryService $categoryService){
        // dd($this->categories);
        $this->categories = $categoryService->getCategoriesActive()->select('uuid', 'name', 'image', 'slug','id')
            ->latest()
            ->get();
    }
...
<main class="main">
    <div class="page-header text-center" style="
          ...
          ">
        <div class="container">
            <h1 class="page-title">Categories<span>Shop</span></h1>
        </div>
        <!-- End .container -->
    </div>
    <!-- End .page-header -->
...
<ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('public.category.index') }}">Shop</a></li>
            </ol>
        </div>
        <!-- End .container -->
    </nav>
                        ...
                        <div class="col-sm-6 col-md-3 order-md-last">
                            <div class="banner banner-cat banner-badge">
                                <a href="{{ route('public.category.products.index',$category->slug) }}">
                                    <img src="{{ asset($category->image) }}" alt="Banner" style="height: 350px; " />
                                </a>

                                <a class="banner-link" href="{{ route('public.category.products.index',$category->slug) }}">
                                    <h3 class="banner-title">{{ $category->name }}</h3>
                                    <!-- End .banner-title -->
                                    <h4 class="banner-subtitle">{{ $category->productsCount() }} Products</h4>
                                    <!-- End .banner-subtitle -->
