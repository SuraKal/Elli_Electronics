...
new #[Layout('components.layouts.admin')] class extends Component {
    ...
    {
        return Template::where('name', 'like', '%' . $this->search . '%')
...
<x-slot name="header">
    <div class="flex justify-between items-center">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('List of Templates') }}
        </h2>

        <a href="{{ route('admin.store.template.create') }}"
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <section>
                <x-action-message class="me-3" on="template-deleted" message='Template Removed'/>
                        ...
                        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                            <thead class="text-left bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 font-medium text-gray-900">Template Status</th>
