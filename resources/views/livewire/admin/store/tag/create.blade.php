...
new #[Layout('components.layouts.admin')] class extends Component{
    ...
    public function store()
    {
        $this->validate([
            ...
            'name.unique' => 'Tags already exists.',
                ...
                <section>
                    <header>
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            {{ __('Ensure your tag name is short, descriptive, and unique.') }}
                        </p>
                    </header>

                    <x-action-message class="me-3" on="tag-created" message='Tag Added'/>
                    ...
                    <form wire:submit="store" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input wire:model="name" name="name" type="text" class="mt-1 block w-full"
                                autocomplete="name" aria-placeholder="Living room, Woodlights ..."
                                placeholder="Living room, Woodlights ..." required/>
