                ...
                <div class="row">
                                    ...
                                    <td class="product-col">
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="static/assets/images/products/table/product-1.jpg"
                                                        alt="Product image" />
                                                </a>
                                            </figure>
                                ...
                                <tr>
                                    <td class="product-col">
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="static/assets/images/products/table/product-2.jpg"
                                                        alt="Product image" />
                                                </a>
                                            </figure>
                                    ...
                                    <td class="price-col">ETB 76.00</td>
                                    <td class="quantity-col">
                                        <div class="cart-product-quantity">
                                            <input type="number" class="form-control" value="1" min="1" max="10"
                                                step="1" data-decimals="0" required />
                                    ...
                                    <td class="total-col">ETB 76.00</td>
                                    <td class="remove-col">
                                        <button class="btn-remove">
                                            <i class="icon-close"></i>
                                        </button>
                    ...
                    <aside class="col-lg-3">
                        <div class="summary summary-cart">
                            ...
                            <a href="{{ route('shop.transaction.checkout') }}" class="btn btn-outline-primary-2 btn-order btn-block">PROCEED TO
                                CHECKOUT</a>
                        </div>
                        <!-- End .summary -->

                        <a href="{{ route('public.category.index') }}" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE
