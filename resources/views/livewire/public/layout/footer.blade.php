...
<footer class="footer footer-2">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-6">
                    <div class="widget widget-about">
                        <img src="{{ asset('static/assets/images/collections/logo/logo.png') }}" class="footer-logo"
                            alt="Elli electronics Logo" width="105" height="25">
                        ...
                        <div class="widget-about-info">
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <a href="tel:123456789">+251 911232839</a>
                                </div><!-- End .col-sm-6 -->
                                <div class="col-sm-6 col-md-8">
                                    <span class="widget-about-title">Payment Method</span>
                                    <figure class="footer-payments">
                                        <img src="{{ asset('static/assets/images/payments.png') }}"
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © 2025 Elli Store. All Rights Reserved.</p>
