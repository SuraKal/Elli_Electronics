...
new class extends Component {
    ...
    // public function getProductsProperty(ProductService $productService)
    // {
    //     return $productService->getProductsActive()
    //         ->select('uuid', 'name', 'image', 'slug', 'price','id')
    //         ->latest()
    //         ->get();
    // }
    ...
    public $products;
    public function mount(CategoryService $categoryService,ProductService $productService){
