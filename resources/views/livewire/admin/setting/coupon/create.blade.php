                ...
                <section>
                    <header>
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            {{ __('Make sure the coupon name and code are unique.') }}
                        </p>
                    </header>

                    <x-action-message class="me-3" on="coupon-created" message="Coupon Created" />
                    ...
                    <form wire:submit="create" class="mt-6 space-y-6">
                        ...
                        <div>
                            <x-input-label for="discount_value" :value="__('Discount Value (In Percent)')" />
